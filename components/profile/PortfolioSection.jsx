          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-xl text-sm leading-6 text-slate-500">
                Showcase your work and help people understand what you can do.
              </p>
            </div>
          </div>
  ...
  return (
    <article className="group overflow-hidden rounded-2xl border border-slate-200 bg-white transition duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-950/[0.04]">
      ...
      <div className="p-5">
        ...
        <h3 className="mt-3 truncate text-sm font-black tracking-[-0.015em] text-slate-950">
          {title}
        </h3>
...
function AddWorkCard({ onClick }) {
  return (
    ...
    >
      ...
      <span className="mt-4 text-sm font-black tracking-tight text-slate-950">
        Add another work
      </span>

      <span className="mt-1 max-w-[220px] text-sm font-medium leading-6 text-slate-400">
